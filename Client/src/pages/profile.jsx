...
export default function Profile() {
  ...
  const handleAboutSave = async () => {
    try {
      const token = localStorage.getItem('token');
      const userId = extractUserIdFromToken(token);
      await axios.put(`http://localhost:5000/${userId}/about`, {
            ...
            <MDBCard>
              ...
              >
                ...
                >
                  ...
                  <MDBBtn
                    outline
                    color='text'
                    className='h-9 px-6 ring-2 ring-black text-black'
                  >
                    Edit profile
                  </MDBBtn>
                </div>
              ...
              <MDBCardBody className='text-black p-4'>
                <div className='mb-5'>
                  ...
                  {editableAbout && (
                    <MDBBtn className='mt-2 px-4 py-2 bg-[#eb2168] text-white rounded-md hover:bg-[#d7004b] transition duration-300 ease-in-out transform focus:outline-none focus:ring focus:ring-[#e85c8d]' onClick={handleAboutSave}>Save</MDBBtn>
                  )}
                </div>
